...
class CptController extends BaseController
{
    ...
    public function register()
    {
        ...
        if (!$this->activated('cpt_manager')) return; // if not activated stop and don't activate the cpt manager subpage
    ...
    public function setSettings()
    {
        ...
        foreach ($this->managers as $managerID => $title) {
            ...
            array_push($args,  array(
                'option_group' => 'petizan_cpt_settings',
                'option_name' => 'petizan_cpt',
    ...
    public function storeCustomPostTypes()
    {
        ...
        array_push( $this->custom_post_types,
                    ...
                    array(
                        ...
                        'item_list' => $option['plural_name'] . ' List',
                        'item_list_navigation' => $option['plural_name'] . ' List Navigation',
                        ...
                        'hierarchical' => false,
                        'public' =>  !empty($option['public']) ? $option['public'] : true,
                        'show_ui' => true,
                        'show_in_menu' => true,
                        'menu_position' => 5,
                        'show_in_admin_bar' => true,
                        'can_export' => true,
                        'has_archive' => !empty($option['has_archive']) ? $option['has_archive'] : true,
    ...
    public function registerCustomPostTypes()
    {
        ...
        foreach ($this->custom_post_types as $post_type) {
            register_post_type(
                strtolower($post_type['post_type']),
                array(
                    ...
                    'labels' => array(
                        ...
                        'item_list' => $post_type['item_list'],
                        'item_list_navigation' => $post_type['item_list_navigation'],
                    ...
                    'has_archive' => !empty($post_type['has_archive']) ? $post_type['has_archive'] : true,
